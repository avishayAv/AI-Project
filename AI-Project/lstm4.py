...
def lstm_experiment(csv_name,samples,epochs=50):
    ...
    dataset.set_axis(dataset['Date'],inplace=True)
    ...
    #combiner_nolabel 25 epochs
    #tmp =list(range(122,244))
    #tmp.remove(124)

    #combiner_nomonth 20 epochs
    ...
    print('std %.3f' % (abs(inv_yhat - inv_y)).std())
    return inv_yhat